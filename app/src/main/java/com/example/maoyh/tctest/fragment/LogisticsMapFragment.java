 ...
 */
public class LogisticsMapFragment extends Fragment {
     ...
     * 需要传递参数时有利于解耦
     */
    public static LogisticsMapFragment newInstance() {
        Bundle args = new Bundle();
        LogisticsMapFragment fragment = new LogisticsMapFragment();
